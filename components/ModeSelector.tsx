  ...
  return (
    <div className="inline-flex w-full rounded-2xl border border-stone-200 bg-stone-50 p-1 mb-8 gap-1">
      <button
        ...
        className={`flex-1 px-5 py-3 rounded-xl text-sm font-semibold border transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:ring-offset-2 ${
