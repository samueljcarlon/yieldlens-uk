    ...
    <div className="max-w-4xl mx-auto px-4 py-16 sm:py-20">
      <div className="rounded-[32px] border border-stone-200 bg-white p-7 sm:p-10 shadow-sm">
        ...
        <p className="mt-5 text-sm sm:text-base leading-7 text-stone-700 max-w-2xl">
          We will review the site, business assumptions and evidence gaps before confirming the scope of work. If the case fits the standard one-site scope, the fee is £295. Submitting this intake is not a purchase and does not commit you to proceed.
        </p>
        <div className="mt-7 rounded-2xl border border-stone-200 bg-stone-50 p-5">
          ...
          <p className="mt-2 text-sm leading-7 text-stone-600">
            The review starts with the information you supplied. If key evidence is missing, we may ask for it before confirming the engagement. Standard-scope work targets delivery within 3 working days after the required evidence is received and scope is confirmed. Multi-site or materially more complex work is quoted separately before anything begins.
          </p>
        </div>
