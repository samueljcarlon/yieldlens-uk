        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {interpretationBands.map((band) => (
              ...
              >
                <p className="text-xs uppercase tracking-wide text-[var(--yieldlens-caution)] font-semibold mb-2">
                  {band.range}
                </p>
            ...
            <div className="bg-white text-stone-900 rounded-lg p-6 shadow-xl">
              ...
              <div className="mt-5 flex flex-col sm:flex-row gap-3">
                <TrackedCtaLink
                  ...
                  ctaLabel="Run full commercial lease check"
                  pageType="seo_tool"
                  className="bg-[var(--yieldlens-primary)] text-white px-5 py-3 rounded font-medium hover:bg-[var(--yieldlens-primary-hover)] transition-colors text-sm text-center"
                >
                  Run full commercial lease check
                </TrackedCtaLink>
